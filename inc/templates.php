...
?>
			<div class="icon-wrapper" data-icon="<?php echo $property['name'] ?>">
				<div class="icon">
					...
					<label for="icon-key-<?php echo $property['name'] ?>"><?php _e( 'Class:', 't_em_all' ) ?></label>
					<input id="icon-key-<?php echo $property['name'] ?>" class="form-control form-control-sm" type="text" value="<?php echo 'icomoon-'. $property['name'] ?>" readonly>
				</div>
			</div>
<?php
	endforeach;
